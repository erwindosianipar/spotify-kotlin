...
class ArtistActivityDetail: AppCompatActivity() {
    lateinit var listView: ListView
    lateinit var arrayAdapter: SongArrayAdapter
    var url = "http://10.10.17.153:8080/song/artist/"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        name = "Artist $name"
        val viewName = findViewById<TextView>(R.id.artist_name)
        ...
        fetchSongByArtistID(id)
    }

    private fun fetchSongByArtistID(id: Int) {
